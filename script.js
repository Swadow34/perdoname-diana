...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- ARREGLO DE DATOS: AQUÍ ESTÁN TUS 4 PÁGINAS ---
    // Puedes editar los textos libremente aquí adentro sin tocar el HTML
    const textosCartas = [
        {
            titulo: "Un Bello Comienzo - Página 1",
        ...
        {
            titulo: "Momentos Especiales - Página 2",
        ...
        {
            titulo: "Agradecimientos - Página 3",
        ...
        {
            titulo: "El Final de la Carta - Página 4",
            contenido: "Un 26 de diciembre nos propusimos volver a salir, recuerdo que ese día me desperté algo nervioso porque me dijiste que tenía que ir a hablar con tu papa, en ese momento que me dijiste eso me espante, aunque creo que nunca te lo dije, apenas te iba a conocer y ya estaría conociendo a tu familia, tenía miedo y pensaba, ¿y si no sale bien? ¿Y si después de esta salida me ignora? ¿Y si les caigo mal a sus papas? ¿Y si no le gusto? Todo eso fue cosas que me pregunte esos días, pero al final me anime, sabía que quería ir serio contigo y realmente me anime a ir a hablar con tus papas, con mucha pena desde luego, pero con unas ganas inmensas de conocerte"
        },
        {
            titulo: "El Final de la Carta - Página 5",
        ...
        {
            titulo: "El Final de la Carta - Página 6",
        ...
        {
            titulo: "El Final de la Carta - Página 7",
        ...
        {
            titulo: "El Final de la Carta - Página 8",
        ...
        {
            titulo: "El Final de la Carta - Página 9",
        ...
        {
            titulo: "El Final de la Carta - Página 10",
        ...
        {
            titulo: "El Final de la Carta - Página 11",
        ...
        {
            titulo: "El Final de la Carta - Página 12",
        ...
        {
            titulo: "El Final de la Carta - Página 13",
            contenido: "A la mañana siguiente recuerdo que tardaste en contestar, yo iba rumbo a ver a mis abuelos, te mande fotos y recuerdo contarte que tenía la ilusión de que los conocieras, por desgracia sabias que no los conocí y por lo menos tenía la ilusión de que me acompañaras en esos momentos cuando los fuéramos a visitar, recuerdo a verme quedado en cada tumba y decirles que pronto les traería a alguien, espere a que la mayoría se fuera y les hable en voz baja a los 2 contándoles de ti, me llenaste de una ilusión muy bonita en esos momentos (corazón blanco)"
        },
        {
            titulo: "El Final de la Carta - Página 14",
        ...
        {
            titulo: "El Final de la Carta - Página 15",
        ...
        {
            titulo: "El Final de la Carta - Página 16",
        ...
        {
            titulo: "El Final de la Carta - Página 17",
        ...
        {
            titulo: "El Final de la Carta - Página 18",
        ...
        {
            titulo: "El Final de la Carta - Página 19",
        ...
        {
            titulo: "El Final de la Carta - Página 20",
    ...
    if (container) {
        textosCartas.forEach((carta, index) => {
            ...
            if (index === 0) pageDiv.classList.add('active'); // La primera inicia visible
...
// ==========================================================================
    ...
    if (closeBtn && envelope) {
        closeBtn.addEventListener('click', (e) => {
            e.stopPropagation(); // Evita reabrir por accidente
            
            // Cerrar el sobre quitando la clase open
            envelope.classList.remove('open');
            
            // Resetear la carta a la página 1 de forma silenciosa para cuando vuelvan a abrirla
            setTimeout(() => {
                const paginasHTML = document.querySelectorAll('.letter-page');
